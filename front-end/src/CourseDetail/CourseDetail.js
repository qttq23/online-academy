...
import CourseCarousel from '../Homepage/CourseCarousel/CourseCarousel'
...
const CourseDetail = (props) => {
  const data = [{
    ...
    // image: "../assets/images/course/angular.png",
    ...
    lecturer: {
      ...
      name: "Jojo",
      // propic: "../assets/images/profile/avatar.jpg",
  ...
  return (
    <div className="container">
      <div className="course-detail-container">
        ...
        <div className="course-detail">
          <div className="course-information-container">
            ...
            <h4 className="course-price">Price: ${result.price}</h4>
          </div>
      ...
      <div className="lecturer-information-container">
        ...
        <div>
          <h4><a href="/teachers">{result.lecturer.name}</a></h4>
      ...
      <div className="related-courses-container">
        ...
        <CourseCarousel headlineName="Related courses"></CourseCarousel>
      </div>
      <Divider />
