...
function Homepage(props) {
  ...
  return (
    <div>
      ...
      <h2 style={{ marginLeft: "130px", fontWeight: "Bold", fontSize: "30" }}>MOST VIEWED COURSE</h2>
      <HotCourse courseList={store.getState().mostViewedCourses}></HotCourse>
      <h2 style={{ marginLeft: "130px", marginTop: "50px", fontWeight: "Bold", fontSize: "30" }}>HOT COURSE</h2>
      <HotCourse></HotCourse>
